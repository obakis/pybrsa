...
*A vignette demonstrating how to use main functions, download and save data from both BDDK and FinTurk interface can be found at*: [Getting Started](introduction.html){.uri}
